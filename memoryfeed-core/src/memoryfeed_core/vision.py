...
from memoryfeed_core.llm_clients import caption_image_with_gemini, rewrite_or_summarize_with_groq
from memoryfeed_core.resilience import backoff_seconds
from memoryfeed_core.runtime_config import load_runtime_config
from memoryfeed_core.store import IMAGE_CACHE_DIR, IMAGE_ENCRYPTED_DIR, Store

logger = logging.getLogger(__name__)
VISION_PROMPT = (
    "Hãy mô t? chi ti?t ?nh này. N?u là meme, nêu rõ ch? trong ?nh và ý gây cu?i. "
    "N?u là ?nh ch?p, mô t? b?i c?nh và hành d?ng chính th?t c? th?. "
    "Gi? nguyên ngôn ng? dang xu?t hi?n trong ?nh; n?u không có ch? thì tr? l?i b?ng ti?ng Vi?t."
)
